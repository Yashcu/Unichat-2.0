...
import CreateTaskForm from '../../components/CreateTaskForm'; // Import the form

const StudentDashboard = () => {
  const { user } = useAuth();
  const [stats, setStats] = useState({ tasks: 0, upcomingEvents: 0, recentMessages: 0 });
  ...
  return (
    <>
      <Modal isOpen={isTaskModalOpen} onClose={() => setIsTaskModalOpen(false)} title="Create a New Task">
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 mt-2">Here is your academic summary.</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button onClick={() => setIsTaskModalOpen(true)} className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-center">
...
// ... (StatCard and QuickActionLink helper components remain the same)
